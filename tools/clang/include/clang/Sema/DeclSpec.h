...
public:
  ...
  static const TST TST_lint = clang::TST_int;  // 64, signed
  static const TST TST_usint = clang::TST_char; // 8, unsinged
  static const TST TST_uint = clang::TST_int;   // 16, unsigned
  static const TST TST_udint = clang::TST_int;// 32, unsigned
  static const TST TST_ulint = clang::TST_int;// 64, unsigned
  static const TST TST_real = clang::TST_float;
  static const TST TST_lreal = clang::TST_double;
  ...
  static const TST TST_function = clang::TST_function;
  static const TST TST_function_block = clang::TST_function_block;
  static const TST TST_program = clang::TST_program;
